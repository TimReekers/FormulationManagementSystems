...
namespace FormulationManagementSystems
{
    [NestedLocalTexts]
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your Formulation Management Systems Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to FMS (Formulation Management Systems)";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your Formulation Management Systems Account";
                    ...
                    public static LocalText FormTitle = "Sign up for Formulation Management Systems";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "FMS";
        }
