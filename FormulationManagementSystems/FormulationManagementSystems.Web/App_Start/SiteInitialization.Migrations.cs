namespace FormulationManagementSystems
{
    ...
    { 
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want FormulationManagementSystems migrations to run on your DB.
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "FormulationManagementSystems.Migrations." + databaseKey + "DB",
                    Timeout = 90
                };
